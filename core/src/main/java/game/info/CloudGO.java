...
public class CloudGO implements Screen {
    ...
    public CloudGO(final MyGames game) {
        this.game = game;
    ...
    private void createUI() {
        ...
        restartButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                game.playClickSound();
                game.setScreen(new CloudScreen(game)); // Создаем новый экран игры
                dispose();
            }
        });
        ...
        homeButton.addListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                game.playClickSound();
                game.setScreen(new GameScreen(game)); // Используйте game.setScreen для корректного перехода
                dispose();
            }
        });
